...
const TopicList = ({ id, status }: Props) => {
    ...
    return (
        <div className='relative w-full'>
            ...
            <div className={`${isOpenSidebar ? 'xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 grid-cols-2' : 'xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-3 grid-cols-2'} grid gap-4 mb-5 pt-1.5 px-0 transition-all`}>
                {topics.map(topic => (
