...
export default function TopicLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <main>
            <div className='px-4 pb-4 flex gap-4 relative'>
                <div
                ...
                <div className='h-[calc(100vh-58px-32px)] min-w-[300px] w-[300px] sticky top-4 bottom-4'>
                    <ContainerCard classNames='mb-[0px] p-[0px]'>
