...
const WorkSpace = ({ params }: Props) => {
    const { isOpen, loading: loadingForm, selectedWorkspace } = useAppSelector(WorkspaceSelectors.getForm());
    const { workspace, loading } = useAppSelector(WorkspaceSelectors.getWorkspace());
    const dispatch = useAppDispatch();

    useEffect(() => {
        if (!params?.id) return;
        dispatch(WorkspaceThunks.getAll())
        // dispatch(WorkspaceThunks.getById(params.id))
    }, [params])
...
const data: Task[] = [
    {
        ...
        "deletedAt": "2023-08-02T15:30:00Z"
    },
    {
        "title": "Task B",
        ...
        "deletedAt": "2023-08-04T12:20:00Z"
    },
    {
        "title": "Another Task",
        ...
        "deletedAt": "2023-08-05T09:10:00Z"
    },
    {
        "title": "Project XYZ",
        ...
        "deletedAt": "2023-08-10T16:45:00Z"
    },
    {
        "title": "Meeting Notes",
        ...
        "deletedAt": "2023-08-11T09:00:00Z"
    },
    {
        "title": "Task C",
        ...
        "deletedAt": "2023-08-14T10:45:00Z"
    },
    {
        "title": "Task D",
        ...
        "deletedAt": "2023-08-17T14:20:00Z"
    },
    {
        ...
        "deletedAt": "2023-08-20T16:10:00Z"
    },
    {
        "title": "Task E",
        ...
        "deletedAt": "2023-08-22T14:00:00Z"
    },
    {
        ...
        "deletedAt": "2023-08-25T12:30:00Z"
    },
    {
        "title": "Task F",
        ...
        "deletedAt": "2023-08-27T15:20:00Z"
    },
    {
        ...
        "deletedAt": "2023-08-29T11:15:00Z"
    },
    {
        "title": "Task G",
        ...
        "deletedAt": "2023-08-31T14:20:00Z"
    },
    {
        ...
        "deletedAt": "2023-09-02T16:45:00Z"
    },
    {
        "title": "Task H",
        ...
        "deletedAt": "2023-09-04T12:10:00Z"
    },
    {
        "title": "Task I",
        ...
        "deletedAt": "2023-09-06T15:00:00Z"
    },
    {
        ...
        "deletedAt": "2023-09-09T14:20:00Z"
    },
    {
        "title": "Task J",
        ...
        "deletedAt": "2023-09-11T12:40:00Z"
    }
]
