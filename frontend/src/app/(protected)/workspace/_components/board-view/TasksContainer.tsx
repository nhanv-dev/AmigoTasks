        ...
        <div className='flex-1 max-w-[380px] transition-theme rounded-md'>
            <div className='mb-3 flex items-center justify-between gap-4'>
                ...
                <div className='flex items-center justify-end gap-1.5'>
                    <button tabIndex={-1} className='text-[1.2rem] text-text-50 dark:text-dark-text-50 bg-[transparent] dark:bg-dark-background transition-theme rounded-sm p-0.5'>
                        <IoIosAdd />
                    </button>
                    <button tabIndex={-1} className='text-[1.3rem] text-text-50 dark:text-dark-text-50 bg-[transparent] dark:bg-dark-background transition-theme rounded-sm p-0.5'>
                        <BiChevronDown />
                    </button>
                </div>
