...
export class HttpRequest {
  public static async get<T = any>(url: string, config: any = {}) {
    return instance.request<any, T>({ method: "GET", url, ...config });
  }

  public static async post<T = any, D = any>(
    url: string,
    data: D,
    config: any = {}
  ) {
  ...
  public static async patch<T = any, D = any>(
    url: string,
    data: D,
    config: any = {}
  ) {
  ...
  public static async put<T = any, D = any>(
    url: string,
    data: D,
    config: any = {}
  ) {
